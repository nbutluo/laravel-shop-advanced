        ...
        <div class="order-bottom">
          <div class="order-info">
            ...
            <div class="line">
              ...
              <div class="line-value">{{ \App\Models\Order::$shipStatusMap[$order->ship_status] }}
              </div>
            </div>
            <!-- 如果有物流信息则展示 -->
            @if ($order->ship_data)
            ...
            <div class="line">
              ...
              <div class="line-value">
                {{ \App\Models\Order::$refundStatusMap[$order->refund_status] }}</div>
            </div>
            <div class="line">
          ...
          <div class="order-summary text-right">
            ...
            <div>
              ...
              @if ($order->type !== \App\Models\Order::TYPE_CROWDFUNDING && $order->paid_at && $order->refund_status ===
  ...
  $(document).ready(function() {
            ...
            $('#btn-wechat').click(function() {
                swal({
                        ...
                        content: $(
                            '<img src="{{ route('payment.wechat', ['order' => $order->id]) }}" />'
                        )[0],
